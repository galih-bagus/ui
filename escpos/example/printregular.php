...
//$logo = EscposImage::load("resources/logouniV1.png", false);
$server = "localhost";
$user = "root";
$password = "";
$database = "uipayment";
...
// echo $id;
header("Location: http://serverku.dlinkddns.com/u&i/payment/addregular", true, 301);
...
//header("Location: http://192.168.1.129/u&i/payment/addregular", true, 301);
