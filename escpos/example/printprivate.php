...
// echo $id;
header("Location: http://serverku.dlinkddns.com/u&i/payment/addprivate?print=1", true, 301);
...
class itemP
{
    ...
    {
        $leftCols = 0;
        $att = str_pad($this -> attend, $leftCols) ;
        return "$att\n";
    }
}

//header("Location: http://192.168.1.129/u&i/payment/addprivate", true, 301);
